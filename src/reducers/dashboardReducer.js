...
function dashboardReducer(state, action) {
  switch (action.type) {
    ...
    case "QUERY_FAIL": return { ...state, isQuerying: false, isResetting: false, error: action.error };
    ...
    case "RESET": return { ...state, ...action.customDashboardParams, isResetting: true };
